...
> **Частично архивный документ.** Принципы модульности и React-компоненты
> остаются действующими. Описанная ниже PHP-структура сохранена как история;
> актуальный backend реализован модулем NestJS `admin-dictionaries` и описан в
> `docs/ADMIN_DICTIONARIES_API_NODE.md`.

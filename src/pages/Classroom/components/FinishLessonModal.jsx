        ...
        <div className="finish-lesson">
            ...
            >
                ...
                <p className="finish-lesson__text">
                    ...
                    После этого преподаватель сможет заполнить журнал,
                    а ученик — увидеть опубликованный результат в дневнике
                    и оставить отзыв. Домашнее задание подключается отдельно.
                </p>
